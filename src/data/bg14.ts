...
export const comps: Comp[] = [
  {
    ...
    cards: [
      { name: "Glambot", cardId: "BG36_853", tier: 5, type: "Mech", text: "Spell on Mech creates a 6/6 Satellite." },
      { name: "Spark Snapper", cardId: "BG36_851", tier: 4, type: "Mech", text: "Playing Mechs creates and improves Satellites." },
      { name: "Drone Duplicator", cardId: "BG36_506", tier: 4, type: "Mech", text: "Activate doubles the next Magnetization." },
      { name: "Utility Drone", cardId: "BG26_152", tier: 6, type: "Mech", text: "End-of-turn scaling for Magnetized minions." },
    ],
  ...
  },
  {
    ...
    cards: [
      { name: "Thorned Trailblazer", cardId: "BG31_327", tier: 6, type: "Quilboar", text: "Choose One cards can take both effects." },
      { name: "Gem Rat", cardId: "BG31_326", tier: 4, type: "Quilboar", text: "Gem Day support and Gem flow." },
      { name: "Turbo Hogrider", cardId: "BG31_323", tier: 5, type: "Quilboar", text: "Choose One payoff that turns targeted Gems wide." },
      { name: "Bramble Tunneler", cardId: "BG36_331", tier: 3, type: "Quilboar", text: "Season 14 Quilboar setup piece." },
    ],
  ...
  },
  {
    ...
    cards: [
      { name: "Twilight Tidehunter", cardId: "BG36_703", tier: 4, type: "Murloc", text: "Spells buff the left-most minion in hand." },
      { name: "Shamanic Tidecaller", cardId: "BG36_704", tier: 5, type: "Murloc", text: "Spells buff Murlocs in hand and board." },
      { name: "Kelp Keeper", cardId: "BG36_701", tier: 4, type: "Murloc", text: "Activate triggers a friendly Battlecry." },
      { name: "Gearfin", cardId: "BG36_764", tier: 4, type: "Mech/Murloc", text: "End of turn gives two 1-Cost Tavern spells." },
    ],
  ...
  },
  {
    ...
    cards: [
      { name: "Dead Bellringer", cardId: "BG36_511", tier: 4, type: "Undead", text: "Activate gives Reborn, destroys, and gains stats." },
      { name: "Barrier Banshee", cardId: "BG36_514", tier: 5, type: "Undead", text: "Reborn triggers grant Divine Shield and stats." },
      { name: "Snazzy Phantom", cardId: "BG36_515", tier: 6, type: "Undead", text: "Reborn triggers feed Attack stats rightward." },
    ],
  ...
  },
  {
    ...
    cards: [
      { name: "Air Baller", cardId: "BG36_181", tier: 5, type: "Elemental", text: "Selling gives your minions +2/+2 and improves future Ballers." },
      { name: "Unbound Tempest", cardId: "BG36_352", tier: 6, type: "Elemental", text: "Every 3 Elementals gains high-Health Tavern stats." },
      { name: "Moat Custodian", cardId: "BG36_351", tier: 6, type: "Elemental", text: "Rally improves Elemental buffs this game." },
      { name: "Living Prison", cardId: "BG36_180", tier: 4, type: "Elemental", text: "Activate gains the stats of your next buy." },
    ],
  ...
  },
  {
    ...
    cards: [
      { name: "Cagey Conjurer", cardId: "BG36_508", tier: 3, type: "Naga", text: "Activate casts a random Tavern spell." },
      { name: "Torrential Ruiner", cardId: "BG36_622", tier: 6, type: "Naga", text: "Spells on Naga give your minions +3/+3." },
    ],
  ...
  },
  {
    ...
    cards: [
      { name: "Treasure Parrot", cardId: "BG36_763", tier: 3, type: "Beast/Pirate", text: "Damage quest rewards a Golden Touch." },
      { name: "Captain Cookie", cardId: "BG36_760", tier: 4, type: "Murloc/Pirate", text: "Deathrattle gives Chef's Choice." },
    ],
  ...
  },
  {
    ...
    cards: [
      { name: "Treasure Parrot", cardId: "BG36_763", tier: 3, type: "Beast/Pirate", text: "A Beast/Pirate bridge into Golden value." },
    ],
  ...
  },
  {
    ...
    cards: [
      { name: "Bronze Timewalker", cardId: "BG36_242", tier: 3, type: "Dragon", text: "Season 14 Dragon setup piece." },
      { name: "Sky-hatch Runaway", cardId: "BG36_243", tier: 4, type: "Dragon", text: "Season 14 Dragon payoff piece." },
      { name: "Runic Arcanist", cardId: "BG36_245", tier: 6, type: "Dragon", text: "Late Dragon spell/Rally support." },
      { name: "Warpwing", cardId: "BG24_004", tier: 6, type: "Dragon", text: "Immune while attacking carry." },
    ],
  ...
  },
  {
    ...
    cards: [
      { name: "Deft Deserter", cardId: "BG36_621", tier: 2, type: "Demon", text: "Season 14 Demon setup piece." },
      { name: "Imp-lusionist", cardId: "BG36_731", tier: 4, type: "Demon", text: "Season 14 Demon value piece." },
      { name: "Eredar Escapist", cardId: "BG36_733", tier: 5, type: "Demon", text: "Season 14 Demon payoff piece." },
    ],
